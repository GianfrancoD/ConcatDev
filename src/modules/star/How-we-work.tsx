...
export default function ComoTrabajamos() {
  ...
  const steps = [
    ...
    },
    {
      ...
      title: "Propuesta Estratégica y Planificación",
      description:
    ...
    },
    {
      ...
      title: "Diseño y Desarrollo del Proyecto",
      description:
    ...
    },
    {
      ...
      title: "Revisión, Ajustes y Refinamiento",
      description: "Refinamos el proyecto basándonos en tus comentarios.",
      details:
    ...
    },
    {
      ...
      title: "Testeos, Debugs y Optimización",
      description: "Identificamos y corregimos errores técnicos.",
      details:
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-300 max-w-2xl mx-auto">
            Nuestro proceso está diseñado para garantizar transparencia,
            eficiencia y resultados excepcionales en cada proyecto.
          </p>
        </div>
